...
int main(int argc, char* argv[])
{
	...
	while(exists(strbuf))
	{
		...
		while( (ret = sqlite3_step(stmt)) == SQLITE_ROW)
		{
			...
			res = PQexecParams(conn, "INSERT INTO messages (job_id, rank,tstamp, key, value) VALUES (($1::text)::integer, ($2::text)::integer, ($3::text)::timestamp, $4, $5);", 5, NULL, pgvalues, NULL, NULL, 0);
			if( PQresultStatus(res) != PGRES_COMMAND_OK)
			{
